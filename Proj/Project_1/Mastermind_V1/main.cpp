...
void game(unsigned short &,unsigned short &,unsigned short &,unsigned int,Save *,Table);
...
int main(int argc, char** argv) {
    ...
    do{
        ...
        if(again){    //check if the player is playing game
            Table *table=new Table (holes,tries);
            //play the game
            game(mod,holes,tries,uloc,uData,table);
 ...
 ******************************************************************************/
void game(unsigned short &m,unsigned short &h,unsigned short &t,unsigned int l,Save *d,Table table){
    //declare variables
...
void hardshp(bool &x,unsigned short &m,unsigned short &h,unsigned short &t){
    ...
    bool valid; //input validation boolean
    //validation
    do{
        ...
        case 'C': case 'c': {
            ...
            do{
                ...
                if(valid){
                    ...
                    if(m<6 || m>9){
                        valid=false;
                        cout<<"Please enter a number from 6 to 9"<<endl;
                    }
                }
            }while(!valid);
            do{
